...
<rss version="2.0" xmlns:podcast="https://github.com/Podcastindex-org/podcast-namespace/blob/main/docs/1.0.md">
  <channel>
    <author>ChadF</author>
    <title>Mutton, Mead & Music Playlist</title>
    <description>Curated playlist from Mutton, Mead & Music podcast featuring Value4Value independent artists</description>
    <link>https://mmmusic.show/</link>
...
// Main function
async function createMuttonMeadPlaylist() {
  try {
    console.log('🎵 Fetching Mutton, Mead & Music RSS feed...');
    
    const feed = await parser.parseURL('https://mmmusic-project.ams3.cdn.digitaloceanspaces.com/Mutton_Mead__Music/feed.xml');
    ...
    const xmlData = await new Promise((resolve, reject) => {
      https.get('https://mmmusic-project.ams3.cdn.digitaloceanspaces.com/Mutton_Mead__Music/feed.xml', (res) => {
        let data = '';
    ...
    const outputPath = path.join(__dirname, '..', 'docs', 'muttonmead-playlist.xml');
...
if (require.main === module) {
  createMuttonMeadPlaylist();
}

module.exports = { createMuttonMeadPlaylist };
