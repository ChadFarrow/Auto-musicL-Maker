...
<rss version="2.0" xmlns:podcast="https://github.com/Podcastindex-org/podcast-namespace/blob/main/docs/1.0.md">
  <channel>
    <author>ChadF</author>
    <title>Behind the Sch3m3s Music Playlist</title>
    <description>Curated playlist from Behind the Sch3m3s podcast featuring independent artists</description>
    <link>https://music.behindthesch3m3s.com/</link>
...
// Main function
async function createBehindTheSchemesPlaylist() {
  try {
    console.log('🎵 Fetching Behind the Sch3m3s RSS feed...');
    
    const feed = await parser.parseURL('https://music.behindthesch3m3s.com/b4ts feed/feed.xml');
    ...
    const xmlData = await new Promise((resolve, reject) => {
      https.get('https://music.behindthesch3m3s.com/b4ts feed/feed.xml', (res) => {
        let data = '';
    ...
    const outputPath = path.join(__dirname, '..', 'docs', 'behindtheschemes-playlist.xml');
...
if (require.main === module) {
  createBehindTheSchemesPlaylist();
}

module.exports = { createBehindTheSchemesPlaylist };
