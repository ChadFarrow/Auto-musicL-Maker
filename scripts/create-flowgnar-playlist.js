...
<rss version="2.0" xmlns:podcast="https://github.com/Podcastindex-org/podcast-namespace/blob/main/docs/1.0.md">
  <channel>
    <title>Flowgnar Music Playlist</title>
    <description>Curated playlist from Flowgnar podcast featuring outdoor adventure music</description>
    <author>Auto musicL Maker</author>
    <link>https://flowgnar.com/</link>
...
async function createFlowgnarPlaylist() {
  try {
    console.log('🎵 Fetching Flowgnar RSS feed...');
    
    const feed = await parser.parseURL('https://feeds.oncetold.net/80000060');
    ...
    const xmlData = await new Promise((resolve, reject) => {
      https.get('https://feeds.oncetold.net/80000060', (res) => {
        let data = '';
    ...
    const outputPath = path.join(__dirname, '..', 'docs', 'flowgnar-playlist.xml');
...
if (require.main === module) {
  createFlowgnarPlaylist();
}

module.exports = { createFlowgnarPlaylist };
